...
benchmark_df = pd.read_csv("/Users/federicadomecq/Documents/golfModeL47/broadiedata/strokes_on_green_feet.csv")
...
plt.plot(gpr_df["feet"], gpr_df["pred"], label="Your GPR Prediction", color="green", lw=2)
